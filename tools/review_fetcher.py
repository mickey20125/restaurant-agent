...
class ReviewFetcherSkill:
    ...
    def run(
        ...
        *,
        ...
        for candidate in candidates:
            ...
            candidate.phone = place.phone or candidate.phone
            candidate.website = place.website or candidate.website
            if place.reservable is not None:
                candidate.reservable = place.reservable
    ...
    def _hydrate_candidate(candidate: Candidate, payload: dict) -> None:
        ...
        candidate.website = payload.get("website")
        candidate.reservable = payload.get("reservable")
